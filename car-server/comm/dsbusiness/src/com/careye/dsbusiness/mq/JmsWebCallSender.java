 ...
 *     
 * 项目名称：dsbusiness    
 * 类名称：JmsWebCallSender    
 * 类描述： 上行电召业务队列名称   
 * 创建人：zr    
 * 创建时间：2015-5-25 下午04:58:06    
 * 修改人：zr    
 * 修改时间：2015-5-25 下午04:58:06    
 * 修改备注：    
 * @version 1.0  
 *     
 */
public class JmsWebCallSender implements ExceptionListener{
	...
	protected static JmsWebCallSender jmsWebCallSender = null;

	/**
	 * 获取唯一实例.
	 * @return
	 */
	public static JmsWebCallSender getInstance(){
		if (jmsWebCallSender == null) {
			jmsWebCallSender = new JmsWebCallSender();
		}
		return jmsWebCallSender;
	}

	public JmsWebCallSender() {
		init();
	}
