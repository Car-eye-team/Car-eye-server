 ...
 * 类描述：    
 * 创建人：zr    
 * 创建时间：2015-5-12 下午05:04:21    
 * 修改人：zr    
 * 修改时间：2015-5-12 下午05:04:21    
 * 修改备注：    
 * @version 1.0  
 *
 */
public class ThreadPoolManager {
	...
	public void initThreadPool(){
		try {
			...
			executor = new ThreadPoolExecutor(ConfigProperties.corePoolSize, ConfigProperties.maximumPoolSize,ConfigProperties.keepAliveTime, TimeUnit.SECONDS, queue,Executors.defaultThreadFactory(),new ThreadPoolExecutor.DiscardOldestPolicy());
