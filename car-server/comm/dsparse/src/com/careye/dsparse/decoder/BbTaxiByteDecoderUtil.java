 ...
 *     
 */
public class BbTaxiByteDecoderUtil {
	...
	public static MulMediaDataLoadResponse getMmdlResponseInfo(JSONObject jsonObject){
		...
		try {
			...
			mmdlResponse.setSeqR(jsonObject.getInt("seqR"));
	 ...
	 * @param positionInfo
	 */
	public static Map setStateMap(String sn,Map <String,Object>  map){
		...
		try {
			...
			map.put("s18", Integer.parseInt(sn.substring(13, 14)));
			...
			map.put("s4", Integer.parseInt(sn.substring(27, 28)));
			/*else if(sn.substring(28, 29).equals("1")){

			}else if(sn.substring(29, 30).equals("1")){

			}*/
			map.put("s1", Integer.parseInt(sn.substring(30, 31)));
			map.put("s1", Integer.parseInt(sn.substring(31, 32)));
	 ...
	 * @param positionInfo
	 */
	public static Map setAlarmStateMap(String an,Map <String,Object>  map){
		try {
