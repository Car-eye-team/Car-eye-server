 ...
 * 类描述：定时任务 管理    
 * 创建人：zr    
 * 创建时间：2015-5-30 上午11:12:01    
 * 修改人：zr    
 * 修改时间：2015-5-30 上午11:12:01    
 * 修改备注：    
 * @version 1.0  
 *     
 */
public class JobManager {
	...
	private void synAuthInfoJobScheduler(Scheduler scheduler) throws SchedulerException {
		...
		CronTrigger cronTrigger = (CronTrigger)TriggerBuilder.newTrigger().withIdentity("synAuthInfoJobTrigger", DEFAULT_GROUP).withSchedule(CronScheduleBuilder.cronSchedule("0 0/3 * * * ?")).build();
		scheduler.scheduleJob(job, cronTrigger);
