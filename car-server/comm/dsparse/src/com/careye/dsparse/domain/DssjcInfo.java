 ...
 *     
 */
public class DssjcInfo extends BaseInfo{
	...
	private List<DssjcInfoItems> items = new ArrayList<DssjcInfoItems>();
	...
	public List<DssjcInfoItems> getItems() {
		return items;
	}

	public void setItems(List<DssjcInfoItems> items) {
		this.items = items;
	}
