Ext.define('CustomerEvaluationApp.view.CustomerEvaluationListView' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.customerEvaluationListView',
			title: '客户评价司机信息列表',
			region: "center",
   			border: true,
			frame: true,
			store: "CustomerEvaluationListStore", 
			multiSelect: true,
...
//			selModel: { selType: 'checkboxmodel' }, //在首列實現checkbox，僅此在首列
			...
			{ header: '客户姓名', width:100, dataIndex: 'cname', sortable: true,locked:true },
			{ header: '客户手机号', width:100, dataIndex: 'cphone', sortable: true,locked:true },
			                  ...
			                  items: [{
						                ...
						                //action : 'export',
						                 handler: function(button){
                                            var con = Ext.create("CustomerEvaluationApp.controller.CustomerEvaluationCtrl");
