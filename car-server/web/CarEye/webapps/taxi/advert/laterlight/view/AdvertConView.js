Ext.define('AdvertManageApp.view.AdvertConView' ,{
...
//			new Ext.grid.RowNumberer(), 
			...
			{ header: '附件', width:100, dataIndex: 'path', sortable: true, 
				renderer:function (value,cellmeta,record){
					
					if(value.length > 0){
						value = window.BIZCTX_PATH + value;
						if(value.endsWith("bmp") || value.endsWith("bng")|| value.endsWith("png")|| value.endsWith("gif") 
						 || value.endsWith("jpg")){
							return "<a target='_blank' href='"+value+"'><img src=" + value + " height='25' width='25'></img></a>"; 
						}else{
