Ext.define('PageSetApp.view.PageSetSearchView' ,{
    extend: 'Ext.form.Panel',
    alias : 'widget.pageSetSearchView',
    title: '企业用户搜索',
    frame : true,
	region: "north",
    height:100,
			        ...
			        change: {
			            ...
			            fn: function(){ 
							...
							store.on('beforeload', function (store, options) {
					            var new_params = { 
					            	clobname: encodeURI(Ext.getCmp('query_blocid').getRawValue())
					            };
