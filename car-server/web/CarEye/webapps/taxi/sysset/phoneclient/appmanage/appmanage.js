...
Ext.application({
	name:'AppManageApp',//为应用程序起一个名字,相当于命名空间
	   //应用的根目录
	appFolder:window.BIZCTX_PATH+ '/taxi/sysset/phoneclient/appmanage',
    ...
    launch:function(){
    	Ext.create('Ext.container.Viewport',{
				   ...
				   //  renderTo:Ext.getBody(),
				     items: [{xtype:'appTypeListView'},{xtype:'appVersionListView'}]
			});
			/*Ext.create('Ext.container.Viewport', {
    layout: 'border',
    items: [{
