Ext.define('AlarmmusicSetApp.view.AlarmmusicSetEditView', {
	extend : 'Ext.window.Window',
	alias : 'widget.alarmmusicSetEditView',
	title : '修改报警类型',
    width : 400,
	layout : 'form',
	itemId :'alarmmusicSetEditWindow',
	animCollapse:false,
	constrain : true,
	...
	items :[ { 
		...
		items : [{
					xtype : 'hidden',
					id:'id',
					name:'alarmmusicSet.id'
				},{
					xtype : 'hidden',
					id:'oldmusicaddr',
					name:'alarmmusicSet.oldmusicaddr'
				},{
					xtype : 'textfield',
					id:'alarmname',
					...
					xtype : 'textfield',
					id:'alarmkey',
					fieldLabel : '<font color="red">*</font>报警类型缩写',
					name : 'alarmmusicSet.alarmkey',
					allowBlank : false,
					blankText : '报警类型缩写不能为空',
					anchor : '100%',
					cls : 'x-textfield'
				}, {
