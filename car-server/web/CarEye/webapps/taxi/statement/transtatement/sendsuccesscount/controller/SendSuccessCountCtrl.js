Ext.define('SendSuccessCountApp.controller.SendSuccessCountCtrl', {
    extend: 'Ext.app.Controller',
    stores: ['SendSuccessCountListStore'],// 声明该控制层要用到的store
    models: ['SendSuccessCountModel'],// 声明该控制层要用到的model
    views: ['SendSuccessCountListView','SendSuccessCountSearchView'],// 声明该控制层要用到的view
    refs: [// 相当于一个映射,这样就可以在控制层方便的通过geter取得相应的对象了
        {
            ref: 'sendSuccessCountListView',
            selector: 'sendSuccessCountListView'
        },{
            ref: 'sendSuccessCountSearchView',
            selector: 'sendSuccessCountSearchView'
        }
    ],
    init: function() {
...
//        }
    	...
    	var drivername=Ext.getCmp('cd_drivername').getValue();
        	location.href= window.BIZCTX_PATH + '/statement/oncalltransaction/answercountjson/excelExportSendSuccessList.action?stime='
...
//        }
		...
		var store = this.getSendSuccessCountListStoreStore();
