 ...
 * @类描述：拍照记录javaBean
 * @创建人：Yuqk
 * @创建时间：2015-3-26 上午10:13:53
 * @修改人：Yuqk
 * @修改时间：2015-3-26 上午10:13:53
 * @修改备注：
 * @version 1.0
 */
public class Photo {
	...
	/**
	 * 分辨率 1:320*210; 2:640*480: 3:800*600; 4:1024*768; 5:176*144;[QCIF];
	 * 6:352*288;[CIF]; 7:704*288;[HALF D1]; 8:701*576;[D1];
	 **/
	...
	/** 处理结果 **/
	private Integer result;//拍照完成后返回更新数据库，不需要考虑
