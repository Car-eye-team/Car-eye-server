...
import com.careye.threadpool.ThreadPoolTask;
...
public class MqReceiver implements MessageListener {
	...
	private final static Logger logger = Logger.getLogger(MqReceiver.class);
	...
	public void init(){
		...
		try{
			...
			destination = session.createQueue(ConfigProperties.DS_WEB_UP_QUEUE_NAME);  
