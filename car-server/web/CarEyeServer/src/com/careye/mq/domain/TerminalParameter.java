...
public class TerminalParameter implements Serializable{
     ...
     * 车辆里程表读数
     */
    private Integer qtcarMile;
    
    /**
     * 车辆所在的市域ID
     */
    private Integer qtcarCityId;
    
    /**
     * 车牌颜色
     */
    private Integer qtcarColor;
    
    /**
     * 车辆所在省域ID
     */
    private Integer qtcarProvinteId;
    
    /**
     * 机动车号牌
     */
    private String qtcarCard;
	...
	public Integer getQtcarMile() {
		return qtcarMile;
	}
	public void setQtcarMile(Integer qtcarMile) {
		this.qtcarMile = qtcarMile;
	}
	public Integer getQtcarCityId() {
		return qtcarCityId;
	}
	public void setQtcarCityId(Integer qtcarCityId) {
		this.qtcarCityId = qtcarCityId;
	}
	public Integer getQtcarColor() {
		return qtcarColor;
	}
	public void setQtcarColor(Integer qtcarColor) {
		this.qtcarColor = qtcarColor;
	}
	public String getQtcarCard() {
		return qtcarCard;
	}
	public void setQtcarCard(String qtcarCard) {
		this.qtcarCard = qtcarCard;
	}
	...
	public Integer getQtcarProvinteId() {
		return qtcarProvinteId;
	}
	public void setQtcarProvinteId(Integer qtcarProvinteId) {
		this.qtcarProvinteId = qtcarProvinteId;
	}
