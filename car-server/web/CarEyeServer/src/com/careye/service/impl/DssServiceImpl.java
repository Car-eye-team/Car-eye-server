...
* 版权所有
*/
package com.careye.service.impl;


import java.util.List;

import com.careye.base.service.GenericService;
import com.careye.domain.TerminalAuth;
import com.careye.service.DssService;
...
public class DssServiceImpl extends GenericService implements DssService{
	 ...
	 */
	@Override
	public int deleteTerminalAuth(String carTel) {
		return baseDao.delete("mysql-dssServiceSQL.deleteTerminalAuth", carTel);
	}
